    ...
    <div className="min-h-screen flex flex-col bg-white dark:bg-primary transition-colors duration-300">
      ...
      <section id="home" className="pt-20 pb-32 px-6">
        <div className="max-w-7xl mx-auto flex flex-col items-center text-center">
          ...
          >
            <Link to="/auth/signup" className="btn-primary text-xl px-10 py-5 flex items-center justify-center gap-2">
              Apply Now <ArrowRight className="w-6 h-6" />
            </Link>
            <Link to="#about" className="btn-secondary text-xl px-10 py-5 flex items-center justify-center">
              Learn More
            </Link>
          </motion.div>
