...
export const ManagerChatPage = () => {
  ...
  return (
    <div className="h-full flex bg-white dark:bg-zinc-900 rounded-2xl md:rounded-3xl overflow-hidden shadow-xl border border-zinc-200 dark:border-zinc-800 relative w-full">
      {/* Sidebar - User List */}
